...
const testi = testimonial.map ((person) => {
    return (
        ...
        <div className="testimonial_card px-4 py-3 pt-5 rounded-2">
          <FaQuoteLeft className="quote_icon rounded-circle" />
          <p>
            Far far away, behind the word mountains, far from the
            countries Vokalia and Consonantia, there live the blind texts.
          </p>
          <div className="testimonial_profile d-flex flex-row gap-md-2 ">
            <img
              src={person.image}
              alt=""
              width={80}
            ...
            <div className="d-flex flex-column align-items-center justify-content-center">
              <h3 className="test-name">Roger Scott</h3>
    ...
    <section className="Testimonal_section">
      <div className="Testimonal py-5">
        <div className="container">
          ...
          <h1 className="text-center">What People Says</h1>
          <div className="row pt-5 mt-5 gap-xs-1 gap-sm-2 gap-md-0 gap-lg-0 ">
            {testi}
          </div>
        </div>
      </div>
